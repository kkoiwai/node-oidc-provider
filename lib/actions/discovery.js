...
module.exports = function discovery(ctx, next) {
  ...
  ctx.body = {
    ...
    verified_claims_supported: features.verifiedClaims.enabled,
  ...
  if (features.verifiedClaims.enabled) {
    ctx.body.trust_frameworks_supported = features.verifiedClaims.trust_frameworks_supported;
    ctx.body.evidence_supported = features.verifiedClaims.evidence_supported;
    if (features.verifiedClaims.documents_supported) ctx.body.documents_supported = features.verifiedClaims.documents_supported;
    if (features.verifiedClaims.documents_methods_supported) ctx.body.documents_methods_supported = features.verifiedClaims.documents_methods_supported;
    if (features.verifiedClaims.documents_validation_methods_supported) ctx.body.documents_validation_methods_supported = features.verifiedClaims.documents_validation_methods_supported;
    if (features.verifiedClaims.documents_verification_methods_supported) ctx.body.documents_verification_methods_supported = features.verifiedClaims.documents_verification_methods_supported;
    if (features.verifiedClaims.electronic_records_supported) ctx.body.electronic_records_supported = features.verifiedClaims.electronic_records_supported;
    ctx.body.claims_in_verified_claims_supported = features.verifiedClaims.claims_in_verified_claims_supported;
    if (features.verifiedClaims.attachments_supported) ctx.body.attachments_supported = features.verifiedClaims.attachments_supported;
    if (features.verifiedClaims.digest_algorithms_supported) ctx.body.digest_algorithms_supported = features.verifiedClaims.digest_algorithms_supported;
  }
