...
module.exports = (provider) => class Grant extends apply([
  ...
  addOIDCVerifiedClaims(claims) {
    this.openid || (this.openid = {});

    this.openid.verifiedClaims = claims;

  }

  getOIDCVerifiedClaimsEncountered() {
    console.log("getOIDCVerifiedClaimsEncountered())");
    console.log(JSON.stringify(this.openid));

    if (this.openid && this.openid.verifiedClaims) {
      return this.openid.verifiedClaims;
    }
    return null;
  }
