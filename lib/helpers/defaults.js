...
function getDefaults() {
  const defaults = {
    ...
    features: {
      ...
      /*
       * features.verifiedClaims
       *
       * title: [OIDC-IDA](https://openid.net/specs/openid-connect-4-identity-assurance-1_0-ID3.html) - Requesting Verified Claims using the "verified_claims" Request Parameter
       *
       * description: Enables the use and validations of `verified_claims` parameter as described in the
       * specification.
       *
       */
      verifiedClaims: { enabled: false },
