...
class MemoryAdapter {
  ...
  async find(id) {
    console.log("[DEBUG] FIND key: " + id + "  value:" + JSON.stringify(storage.get(this.key(id)), null, 2));
  ...
  async upsert(id, payload, expiresIn) {
    console.log("[DEBUG] UPSERT model:" + this.model + " id: " + id + "  payload:" + JSON.stringify(payload, null, 2));
